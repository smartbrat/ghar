...
const VERTICAL_LOCKUP = {
  ...
  'ghartalks.html':           { name: 'GharTalks', href: '/ghartalks' },
  ...
  /* Brand Connect: same single-page-vertical pattern as VideoWorks — the
     word beside the G points at the page's own root so the lockup reads
     as "Ghar.tv · Brand Connect" rather than a bare G. */
  'brand-connect.html':       { name: 'Brand Connect', href: '/brand-connect' },
